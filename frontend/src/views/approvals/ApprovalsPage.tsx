    ...
    <div className="ap-stage">
      <header className="ap-stage__header">
        ...
        <div className="ap-stage__title-block">
          ...
          <h2 className="t-display">Approvals</h2>
      ...
      <section className="ap-stats" aria-label="Approvals summary">
      ...
      <section className="ap-strategy panel">
        <div className="panel__head">How approvals are handled</div>
      ...
      {pending.length === 0 ? (
        ...
        <section className="ap-pending" aria-label="Pending approvals">
          <header className="ap-pending__head">
            <h3 className="t-label">Pending requests</h3>
            <span className="ap-pending__count t-data">{pending.length}</span>
          </header>
