...
- Some signed PDFs invalidate the signature when fields change. There is
  no flag to strip signatures; filling a signed form accepts that its
  signature may no longer verify.
